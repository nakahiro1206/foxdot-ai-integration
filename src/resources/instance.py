...
from src.agent import MusicComposerService
...
music_composer_service = MusicComposerService(fs=fs)
...
@overload
def get_resource(
    resource_type: Literal["MusicComposerService"],
) -> MusicComposerService: ...
@overload
...
def get_resource(
    resource_type: Literal[
        "FileSystem", "FileSystemWatcher", "MusicComposerService", "ProcessManager"
    ],
) -> FileSystem | FileSystemWatcher | MusicComposerService | ProcessManager:
    if resource_type == "FileSystem":
        ...
        return fs_watcher
    elif resource_type == "MusicComposerService":
