...
from psonic import (  # type: ignore
    run,
    stop,
    send_message,
    synth_server,
    set_server_parameter,
    set_server_parameter_from_log,
)

send_command = synth_server.send_command
...
def system_prompt() -> str:
    """Return the system prompt for the Sonic Pi assistant"""
    return system_prompt_internal()
...
def test_send_message():
    ...
    sample_code = """live_loop :flibble do
